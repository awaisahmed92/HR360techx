  ...
  static const List<HrModuleNav> modules = [
    ...
    HrModuleNav(
      ...
      children: [
        ...
        HrSubNav(id: 'loans', label: 'Loans', icon: Icons.account_balance_outlined, screen: 'master', entity: 'loans'),
    ...
    HrModuleNav(
      ...
      children: [
        HrSubNav(id: 'reports', label: 'HR Reports', icon: Icons.assessment_outlined, screen: 'placeholder'),
      ],
    ),
  ];
